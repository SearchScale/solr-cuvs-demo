...
java -jar target/javabin-generator-1.0-SNAPSHOT-jar-with-dependencies.jar data_file=base.1M.fbin output_file=wiki_batch batch_size=10000 docs_count=1000000 legacy=true
```
